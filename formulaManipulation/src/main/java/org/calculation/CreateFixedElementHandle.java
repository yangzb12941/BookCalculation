...
public class CreateFixedElementHandle implements ICreateFixedElement{
    ...
    public void createFixedElement() {
        ...
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("支反力计算公式",new FormulaElement(1,jkzhPrefixLayout,"支反力计算公式",s_5));
        /**固定计公式end*/
        ...
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("被动合力至反弯点的距离",new SingleFormulaElement(1,jkzhPrefixLayout,"被动合力至反弯点的距离",jkzhPrefixLayout.getLayoutMap().get("被动合力至反弯点的距离")));
        ...
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("轴向支反力",new SingleFormulaElement(1,jkzhPrefixLayout,"轴向支反力",jkzhPrefixLayout.getLayoutMap().get("轴向支反力")));
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("主动合力至反弯点的距离",new SingleFormulaElement(1,jkzhPrefixLayout,"主动合力至反弯点的距离",jkzhPrefixLayout.getLayoutMap().get("主动合力至反弯点的距离")));
        ...
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("支点至基坑底面的距离",new SingleFormulaElement(1,jkzhPrefixLayout,"支点至基坑底面的距离",jkzhPrefixLayout.getLayoutMap().get("支点至基坑底面的距离")));
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("基坑底面至反弯点的距离",new SingleFormulaElement(1,jkzhPrefixLayout,"基坑底面至反弯点的距离",jkzhPrefixLayout.getLayoutMap().get("基坑底面至反弯点的距离")));
        ...
        jkzhContext.getElementTemplates().get(jkzhContext.getCalTimes()).put("第几工况",new TextElement(0,"第几工况",String.valueOf(jkzhContext.getCalTimes()+1)));
        /**各工况参数 end*/
    }
}
