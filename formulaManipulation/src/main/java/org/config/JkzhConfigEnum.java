...
public enum JkzhConfigEnum {
	...
	主动土压力水土分算("主动土压力水土分算",
			"\\sigma_{ak}K_{a,i}-2c_{i}\\sqrt{K_{a,i}}",
			"[<地面堆载+>[重度*厚度+...][-(][[[厚度+...][-基坑外水位]][)][*][水常量]]]*主动土压力系数-2*内聚力*根号主动土压力系数+[[厚度+...][-基坑外水位]]*水常量",
			"[<地面堆载+>[重度 \\times 厚度+...][-(][[[厚度+...][-基坑外水位]][)] [\\times] [水常量]]] \\times 主动土压力系数- 2 \\times 内聚力 \\times \\sqrt{根号主动土压力系数}+[[厚度+...][-基坑外水位]] \\times 水常量"),

	被动土压力水土分算("被动土压力水土分算",
			"\\sigma_{pk}K_{p,i}+2c_{i}\\sqrt{K_{p,i}}",
			"[[重度*厚度+...][-(][[[厚度+...]-[基坑内水位]]*[水常量]]]*被动土压力系数+2*内聚力*根号被动土压力系数+[[厚度+...]-[基坑内水位]]*[水常量]",
			"[[重度 \\times 厚度+...][-(][[[厚度+...][-基坑内水位]][)] [\\times] [水常量]]] \\times 被动土压力系数+ 2 \\times 内聚力 \\times \\sqrt{根号被动土压力系数}+[[厚度+...][-基坑内水位]] \\times 水常量"),
