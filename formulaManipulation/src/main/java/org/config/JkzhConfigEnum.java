...
public enum JkzhConfigEnum {
	...
	作用点位置_主动上大于0_下大于0("作用点位置_主动大于0_被动大于0",
			"\\frac{{2 \\times 主动土压力上 + 主动土压力下}}{{主动土压力上 + 主动土压力下}} \\times \\frac{{2 \\times 厚度}}{3}",
			"((2*主动土压力上 + 主动土压力下)/(主动土压力上 + 主动土压力下))*(2*厚度/3)",
			"\\frac{{2 \\times 主动土压力上 + 主动土压力下}}{{主动土压力上 + 主动土压力下}} \\times \\frac{{2 \\times 厚度}}{3}"),

	土压力合力_主动上小于0_下大于0("土压力合力_主动小于0_被动大于0",
			"\\frac{{{主动土压力下^2} \\times 厚度}}{{2\\left(\\left|主动土压力上\\right| + 主动土压力下\\right )}}",
	...
	土压力合力_主动上大于0_下小于0("土压力合力_主动上大于0_下小于0",
			"\\frac{{{主动土压力上^2} \\times 厚度}}{{2\\left(\\left|主动土压力下\\right| + 主动土压力上\\right )}}",
			"math.pow(主动土压力上,2)*厚度/(2*(math.abs(主动土压力下)+主动土压力上))",
			"\\frac{{{主动土压力上^2} \\times 厚度}}{{2 \\times \\left(\\left|主动土压力下\\right| + 主动土压力上\\right)}}"),
	...
	作用点位置_被动上大于0_下大于0("作用点位置_被动上大于0_下大于0",
			"\\frac{{2 \\times 被动土压力上 + 被动土压力下}}{{被动土压力上 + 被动土压力下}} \\times \\frac{{2 \\times 厚度}}{3}",
			"((2*被动土压力上 + 被动土压力下)/(被动土压力上 + 被动土压力下))*(2*厚度/3)",
			"\\frac{{2 \\times 被动土压力上 + 被动土压力下}}{{被动土压力上 + 被动土压力下}} \\times \\frac{{2 \\times 厚度}}{3}"),

	土压力合力_被动上小于0_下大于0("土压力合力_被动上小于0_下大于0",
			"\\frac{{{被动土压力下^2} \\times 厚度}}{{2\\left(\\left|被动土压力上\\right| + 被动土压力下\\right )}}",
	...
	土压力合力_被动上大于0_下小于0("土压力合力_被动上大于0_下小于0",
			"\\frac{{{被动土压力上^2} \\times 厚度}}{{2\\left(\\left|被动土压力下\\right| + 被动土压力上\\right )}}",
			"math.pow(被动土压力上,2)*厚度/(2*(math.abs(被动土压力下)+被动土压力上))",
			"\\frac{{{被动土压力上^2} \\times 厚度}}{{2 \\times \\left(\\left|被动土压力下\\right| + 被动土压力上\\right)}}"),
	...
	支撑轴力("支撑轴力",
			"\\sum_{i=1}^{n}\\left(主动土压力合力 \\times 主动土作用点位置\\right) - \\sum_{i=1}^{m}\\left(被动土压力合力 \\times 被动土作用点位置\\right){\\div}(土压力零点-支撑的轴线)",
