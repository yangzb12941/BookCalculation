...
public enum JkzhConfigEnum {
	...
	主动土压力水土分算("主动土压力水土分算",
			...
			"[<地面堆载+>[重度 \\times 厚度+...]-[[主动深度到水位的距离+...]\\times [水常量]]] \\times 主动土压力系数- 2 \\times 内聚力 \\times \\sqrt{根号主动土压力系数}-[[主动深度到水位的距离+...]*[水常量]]"),

	被动土压力水土分算("被动土压力水土分算",
			"\\sigma_{pk}K_{p,i}+2c_{i}\\sqrt{K_{p,i}}",
			"[[重度*厚度+...]-[[被动深度到水位的距离+...]*[水常量]]]*被动土压力系数+2*内聚力*根号被动土压力系数+[[被动深度到水位的距离+...]*[水常量]]",
			"[[重度 \\times 厚度+...]-[[被动深度到水位的距离+...] \\times [水常量]]] \\times 被动土压力系数+ 2 \\times 内聚力 \\times \\sqrt{根号被动土压力系数}+[[被动深度到水位的距离+...]*[水常量]]"),
