...
public enum JkzhConfigEnum {
	...
	主动土压力("主动土压力",
			...
			"[<地面堆载+>[重度*厚度+...]]*主动土压力系数-2*内聚力*根号主动土压力系数",
			"[<地面堆载+>[重度 \\times 厚度+...]] \\times 主动土压力系数- 2 \\times 内聚力 \\times \\sqrt{根号主动土压力系数}"),

	被动土压力("被动土压力",
			"\\sigma_{pk}K_{p,i}+2c_{i}\\sqrt{K_{p,i}}",
			"[重度*厚度+...]*被动土压力系数+2*内聚力*根号被动土压力系数",
			"[重度 \\times 厚度+...] \\times 被动土压力系数+ 2 \\times 内聚力 \\times \\sqrt{根号被动土压力系数}"),
