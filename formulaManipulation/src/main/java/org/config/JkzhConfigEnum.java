...
public enum JkzhConfigEnum {
	...
	主动土压力("主动土压力",
			...
			"<③(<①地面堆载+>[重度*厚度+...]<②-([厚度+...]-基坑外水位)*水常量>)*主动土压力系数->2*粘聚力*根号主动土压力系数<②+([厚度+...]-基坑外水位)*水常量>",
			"<③(<①地面堆载+>[重度 \\times 厚度+...]<②-([厚度+...]-基坑外水位) \\times 水常量>) \\times 主动土压力系数->2 \\times 粘聚力 \\times \\sqrt{根号主动土压力系数}<②+([厚度+...]-基坑外水位) \\times 水常量>"),

	被动土压力("被动土压力",
			"\\sigma_{pk}K_{p,i}+2c_{i}\\sqrt{K_{p,i}}",
			"<③([重度*厚度+...]<②-([厚度+...]-基坑外水位)*水常量>)*被动土压力系数+>2*粘聚力*根号被动土压力系数<②+([厚度+...]-基坑外水位)*水常量>",
			"<③([重度 \\times 厚度+...]<②-([厚度+...]-基坑外水位) \\times 水常量>) \\times 被动土压力系数+> 2 \\times 粘聚力 \\times \\sqrt{根号被动土压力系数}<②+([厚度+...]-基坑外水位) \\times 水常量>"),

	主动土压力系数("主动土压力系数",
			"\\tan^{2}\\left(45^{\\circ}-\\frac{\\varphi_{i}}{2}\\right)",
			"math.tan(math.toRadians(45-内摩擦角/2))",
	...
	支撑轴力("支撑轴力",
			"\\frac{{主动合力至反弯点的距离}\\sum{{各层土的主动合力}-{被动合力至反弯点的距离}\\sum{{各层土的被动合力}}}}{{支点至基坑底面的距离}+{基坑底面至反弯点的距离}}",
