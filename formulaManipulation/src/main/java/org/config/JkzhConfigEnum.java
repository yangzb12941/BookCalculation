...
public enum JkzhConfigEnum {
	...
	主动土压力("主动土压力",
			...
			"<③(<①地面堆载+>[重度 \\times 厚度+...]<②-([厚度+...]-基坑外水位) \\times 水常量>) \\times 主动土压力系数->2 \\times 黏聚力 \\times \\sqrt{根号主动土压力系数}<②+([厚度+...]-基坑外水位) \\times 水常量>"),

	被动土压力("被动土压力",
			"\\sigma_{pk}K_{p,i}+2c_{i}\\sqrt{K_{p,i}}",
			"<③([重度*厚度+...]<②-([厚度+...]-基坑外水位)*水常量>)*被动土压力系数+>2*黏聚力*根号被动土压力系数<②+([厚度+...]-基坑外水位)*水常量>",
			"<③([重度 \\times 厚度+...]<②-([厚度+...]-基坑外水位) \\times 水常量>) \\times 被动土压力系数+> 2 \\times 黏聚力 \\times \\sqrt{根号被动土压力系数}<②+([厚度+...]-基坑外水位) \\times 水常量>"),
	...
	支撑轴力("支撑轴力",
			...
			"(支撑轴力主动-支撑轴力被动)<④-[支撑轴力  \\times 支撑轴臂-...]>/(土压力零点-支撑的轴线)",
