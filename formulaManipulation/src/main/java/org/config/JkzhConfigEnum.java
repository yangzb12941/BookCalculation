...
public enum JkzhConfigEnum {
	...
	土压力合力_主动上小于0_下大于0("土压力合力_主动小于0_被动大于0",
			...
			"math.pow(主动土压力下,2)*厚度/(2.0*(math.abs(主动土压力上)+主动土压力下))",
			"\\frac{{{主动土压力下^2} \\times 厚度}}{{2 \\times \\left(\\left| 主动土压力上 \\right| + 主动土压力下 \\right)}}"),
	...
	土压力合力_主动上大于0_下小于0("土压力合力_主动上大于0_下小于0",
			"\\frac{{{土压力强度顶面^2} \\times 厚度}}{{2\\left(土压力强度顶面 + \\left|土压力强度底面\\right| \\right )}}",
			"math.pow(主动土压力上,2)*厚度/(2.0*(主动土压力上+math.abs(主动土压力下)))",
			"\\frac{{{主动土压力上^2} \\times 厚度}}{{2 \\times \\left(主动土压力上 + \\left|主动土压力下\\right| \\right)}}"),
	...
	土压力合力_被动上小于0_下大于0("土压力合力_被动上小于0_下大于0",
			"\\frac{{{土压力强度底面^2} \\times 厚度}}{{2\\left(\\left|土压力强度顶面\\right| + 土压力强度底面\\right )}}",
			"math.pow(被动土压力下,2)*厚度/(2.0*(math.abs(被动土压力上)+被动土压力下))",
			"\\frac{{{被动土压力下^2} \\times 厚度}}{{2 \\times \\left(\\left|被动土压力上\\right| + 被动土压力下\\right)}}"),

	作用点位置_被动上小于0_下大于0("作用点位置_被动上小于0_下大于0",
			"\\frac{土压力强度底面}{{\\left|土压力强度顶面\\right| + 土压力强度底面}}\\times\\frac{{2 \\times 厚度}}{3}",
			"被动土压力下/(math.abs(被动土压力上)+被动土压力下)*((2.0*厚度)/3.0)",
			"\\frac{被动土压力下}{{\\left|被动土压力上\\right|+被动土压力下}}\\times\\frac{{2 \\times 厚度}}{3}"),

	土压力合力_被动上大于0_下小于0("土压力合力_被动上大于0_下小于0",
			"\\frac{{{土压力强度顶面^2} \\times 厚度}}{{2\\left(土压力强度顶面 + \\left|土压力强度底面\\right| \\right )}}",
			"math.pow(被动土压力上,2)*厚度/(2.0*(被动土压力上+math.abs(被动土压力下)))",
			"\\frac{{{被动土压力上^2} \\times 厚度}}{{2 \\times \\left(被动土压力上+\\left|被动土压力下\\right| \\right)}}"),
	...
	最大弯矩位置("最大弯矩位置",
			"\\sum{{T}_{c}}=\\sum{{E}_{a}} 或 \\sum{{T}_{c}}+\\sum{{E}_{p}}=\\sum{{E}_{a}}",
			"[两个支点之间支撑轴力汇总]<+⑤[支点到剪力为零这层土各土层的被动土压力合力汇总]>=[支点到剪力为零这层土各土层的主动土压力合力汇总]",
			"[两个支点之间支撑轴力汇总]<+⑤[支点到剪力为零这层土各土层的被动土压力合力汇总]>=[支点到剪力为零这层土各土层的主动土压力合力汇总]"),

	两个支点之间支撑轴力汇总("两个支点之间支撑轴力汇总",
			"",
			"[支撑轴力+...]",
			"[支撑轴力+...]"),

	支点到剪力为零这层土各土层的被动土压力合力汇总("支点到剪力为零这层土各土层的被动土压力合力汇总",
			"",
			"[被动土压力合力+...]",
			"[被动土压力合力+...]"),

	支点到剪力为零这层土各土层的主动土压力合力汇总("支点到剪力为零这层土各土层的主动土压力合力汇总",
			"",
			"[主动土压力合力+...]",
			"[主动土压力合力+...]"),

	最大弯矩("最大弯矩",
			"\\sum{{T}_{ci} \\times {h}_{ci}}=\\sum{{E}_{a} \\times {h}_{ai}} 或 \\sum{{T}_{c}\\times {h}_{ci}}+\\sum{{E}_{p}\\times {h}_{pi}}=\\sum{{E}_{a} \\times {h}_{ai}}",
			"x+[最大弯矩支撑轴矩]<+⑤[最大弯矩被动土合矩]>=[最大弯矩主动土合矩]",
			"x+[最大弯矩支撑轴矩]<+⑤[最大弯矩被动土合矩]>=[最大弯矩主动土合矩]"),
	...
	最大弯矩被动土合矩("最大弯矩被动土合矩",
			"",
			"[被动土压力合力*最大被动弯矩力臂+...]",
			"[被动土压力合力 \\times 最大被动弯矩力臂+...]"),

	最大弯矩主动土合矩("最大弯矩主动土合矩",
			"",
			"[主动土压力合力*最大主动弯矩力臂+...]",
			"[主动土压力合力 \\times 最大主动弯矩力臂+...]"),
	;
